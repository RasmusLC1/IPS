...
# was:	sw	_tmp_13_, 0(_addr_12_)
	addi	x12, x12, 4
# was:	addi	_addr_12_, _addr_12_, 4
# 	mv	_arr_reg_16_,_let_a_10_
	lw	x19, 0(x18)
# was:	lw	_size_reg_21_, 0(_arr_reg_16_)
	mv	x20, x3
# was:	mv	_let_b_15_, x3
	slli	x11, x19, 2
# was:	slli	_tmp_24_, _size_reg_21_, 2
	addi	x11, x11, 4
# was:	addi	_tmp_24_, _tmp_24_, 4
	add	x3, x3, x11
# was:	add	x3, x3, _tmp_24_
	sw	x19, 0(x20)
# was:	sw	_size_reg_21_, 0(_let_b_15_)
	addi	x21, x20, 4
# was:	addi	_res_reg_18_, _let_b_15_, 4
	addi	x18, x18, 4
# was:	addi	_arr_reg_16_, _arr_reg_16_, 4
	mv	x22, x0
# was:	mv	_i_reg_20_, x0
l.loop_beg_22_:
	sub	x11, x22, x19
# was:	sub	_temp_reg_17_, _i_reg_20_, _size_reg_21_
	addi	x22, x22, 1
# was:	addi	_i_reg_20_, _i_reg_20_, 1
	bge	x11, x0, l.loop_end_23_
# was:	bge	_temp_reg_17_, x0, l.loop_end_23_
	lw	x11, 0(x18)
# was:	lw	_temp_reg_17_, 0(_arr_reg_16_)
	addi	x18, x18, 4
# was:	addi	_arr_reg_16_, _arr_reg_16_, 4
# 	mv	x10,_acc_reg_19_
# 	mv	x11,_temp_reg_17_
	jal	f.incr
# was:	jal	f.incr, x10 x11
# 	mv	_tmp_25_,x10
# 	mv	_acc_reg_19_,_tmp_25_
	sw	x10, 0(x21)
# was:	sw	_acc_reg_19_, 0(_res_reg_18_)
	addi	x21, x21, 4
# was:	addi	_res_reg_18_, _res_reg_18_, 4
	j	l.loop_beg_22_
l.loop_end_23_:
	mv	x10, x20
