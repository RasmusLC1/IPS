...
f.even:
	...
	addi	x2, x2, -4
# 	mv	_param_a_28_,x10
# 	mv	_div1_L_34_,_param_a_28_
	li	x11, 2
# was:	li	_div2_R_35_, 2
	div	x12, x10, x11
# was:	div	_mult1_L_32_, _div1_L_34_, _div2_R_35_
	li	x11, 2
# was:	li	_mult2_R_33_, 2
	mul	x11, x12, x11
# was:	mul	_eq_L_30_, _mult1_L_32_, _mult2_R_33_
	mv	x12, x10
...
# 	mv	_arr_reg_67_,_let_a2d_39_
	lw	x19, 0(x11)
# was:	lw	_size_reg_75_, 0(_arr_reg_67_)
	mv	x18, x3
# was:	mv	_let_a2df_66_, x3
	slli	x10, x19, 2
# was:	slli	_tmp_76_, _size_reg_75_, 2
	addi	x10, x10, 4
# was:	addi	_tmp_76_, _tmp_76_, 4
	add	x3, x3, x10
# was:	add	x3, x3, _tmp_76_
	sw	x19, 0(x18)
# was:	sw	_size_reg_75_, 0(_let_a2df_66_)
	addi	x21, x18, 4
# was:	addi	_acc_reg_72_, _let_a2df_66_, 4
	mv	x20, x0
# was:	mv	_i_reg_73_, x0
	addi	x23, x11, 4
# was:	addi	_temp_reg_68_, _arr_reg_67_, 4
	mv	x24, x0
# was:	mv	_j_reg_74_, x0
l.loop_beg_77_:
	bge	x20, x19, l.loop_end_78_
# was:	bge	_i_reg_73_, _size_reg_75_, l.loop_end_78_
	lw	x22, 0(x23)
# was:	lw	_res_reg_71_, 0(_temp_reg_68_)
	lw	x11, 0(x23)
# was:	lw	_temp_reg_69_, 0(_temp_reg_68_)
	addi	x23, x23, 4
# was:	addi	_temp_reg_68_, _temp_reg_68_, 4
# 	mv	_arr_82_,_temp_reg_69_
	lw	x10, 0(x11)
...
# 	mv	_res_reg_70_,_fun_arg_res_80_
	beq	x10, x0, l.filter_false_79_
# was:	beq	_res_reg_70_, x0, l.filter_false_79_
	sw	x22, 0(x21)
# was:	sw	_res_reg_71_, 0(_acc_reg_72_)
	addi	x24, x24, 1
# was:	addi	_j_reg_74_, _j_reg_74_, 1
	addi	x21, x21, 4
# was:	addi	_acc_reg_72_, _acc_reg_72_, 4
l.filter_false_79_:
	addi	x20, x20, 1
...
l.loop_end_78_:
	sw	x24, 0(x18)
# was:	sw	_j_reg_74_, 0(_let_a2df_66_)
	mv	x10, x18
