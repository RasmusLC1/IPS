...
# was:	mv	_let_d_24_, _let_b_22_
	li	x10, 1000
# was:	li	_mult1_L_31_, 1000
# 	mv	_mult2_R_32_,_let_d_24_
	mul	x10, x10, x12
# was:	mul	_plus_L_29_, _mult1_L_31_, _mult2_R_32_
	li	x12, 100
# was:	li	_mult1_L_33_, 100
	mv	x14, x13
# was:	mv	_mult2_R_34_, _let_a_21_
	mul	x12, x12, x14
# was:	mul	_plus_R_30_, _mult1_L_33_, _mult2_R_34_
	add	x10, x10, x12
# was:	add	_plus_L_27_, _plus_L_29_, _plus_R_30_
	li	x12, 10
# was:	li	_mult1_L_35_, 10
# 	mv	_mult2_R_36_,_let_c_23_
	mul	x11, x12, x11
# was:	mul	_plus_R_28_, _mult1_L_35_, _mult2_R_36_
	add	x10, x10, x11
...
# was:	jal	p.putint, x10
	li	x10, 10000
# was:	li	_mult1_L_39_, 10000
# 	mv	_mult2_R_40_,_let_r1_9_
	mul	x10, x10, x18
# was:	mul	_plus_L_37_, _mult1_L_39_, _mult2_R_40_
