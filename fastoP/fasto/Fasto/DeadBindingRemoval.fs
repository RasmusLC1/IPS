    ...
    match e with
        ...
        | ArrayLit  (es, t, pos) ->
            ...
            (anytrue ios,
             ...
             ArrayLit (es', t, pos) )
        (* ToDO: : implement the cases of `Var`, `Index` and `Let` expressions below *)
        | Var (name, pos) ->
        ...
        | Index (name, e, t, pos) ->
            ...
            *)
            ...
            (eios, recordUse name euses,Index(name, e', t, pos))
        ...
        | Let (Dec (name, e, decpos), body, pos) ->
            ...
            *)
            ...
            let (eios, euses, e') = removeDeadBindingsInExp e
            if (isUsed name bodyuses) || eios then
                (eios || bodyio, SymTab.combine (SymTab.remove name bodyuses) euses,
                 Let (Dec (name, e', decpos), body', pos))
            else
